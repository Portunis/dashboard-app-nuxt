      ...
      <div class="grid-wrapper">
        ...
        <div class="d-flex" v-for="row in grid">
          ...
          >
            ...
            <div v-if="cell.type === CELL_TYPES.player"><img class="cell-img" src="@/assets/images/BeerOrDenis/game/head.png" alt=""/></div>
            <div v-if="cell.type === CELL_TYPES.strawberry" class="cell-emoji"><img class="cell-img" src="@/assets/images/BeerOrDenis/game/item.png" alt=""/></div>
            <div v-if="cell.type === CELL_TYPES.finish" class="cell-emoji"><img class="cell-img" src="@/assets/images/BeerOrDenis/game/taxi.png" alt=""/></div>
          </div>
        </div>
      </div>
    </div>
...
import Sidebar from '@/components/BeerOrDenis/Game/Sidebar.vue';
import StartGameModal from '@/components/BeerOrDenis/Game/StartGameModal.vue';
import PauseModal from '@/components/BeerOrDenis/Game/PauseModal.vue';
